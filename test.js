...
async function runTests() {
  ...
  const wallet1 = await createWalletFromMnemonic(vector1.mnemonic, vector1.passphrase);
  ...
  const wallet2 = await createWalletFromMnemonic(vector2.mnemonic, vector2.passphrase);
